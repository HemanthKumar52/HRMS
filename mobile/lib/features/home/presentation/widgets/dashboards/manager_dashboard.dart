      ...
      child: Column(
        children: [
          Row(
            ...
            children: [
              _buildStatItem(context, 'Total Team', '$total', Colors.blue),
              _buildStatItem(context, 'Present', '$present', Colors.green),
              _buildStatItem(context, 'Absent', '$absent', Colors.red),
            ],
          ),
          ...
          ...members.take(5).map((member) {
            ...
            final clockInTime = member['clockInTime'];
